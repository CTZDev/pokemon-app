...
const showTypePokemon = (typesOfPokemon) => {
  ...
  typesOfPokemon.map(({ name }) => {
    ...
    $img.setAttribute("src", `./images/type-pokemons/Icon-${changeTextCapitalized(name)}.png`);
...
const loadingTypePokemon = (firstTypePokemon = null, parentElement = d, textOption = null) => {
  ...
  $selectTypePokemonIcon.setAttribute("src", `./images/type-pokemons/Icon-${changeTextCapitalized(nameTypePokemon)}.png`);
